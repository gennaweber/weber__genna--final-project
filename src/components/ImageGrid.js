  ...
  return (
    <div class="img-container">
      ...
      <Image 
        ...
        setClickedImg={setClickedImg}
      />
      <p class="sub-copy">Click the images to learn more about each site I've created or helped create. This particular website was built first using vanilla Javascript and later refactored to use React.</p>
    </div>
  )
}
